...
public class ConstructionPopup : PopupView
{
    private enum State
    {
        InProgress,
    ...
    protected override void OnOpen()
    {
        ...
        m_StartTimeText.text = DateTimeOffset.FromUnixTimeMilliseconds(m_ConstructionBuilding.Timer.StartTimeMs).ToString();
        m_EndTimeText.text = DateTimeOffset.FromUnixTimeMilliseconds(m_ConstructionBuilding.Timer.EndTimeMs).ToString();
